...
- Improved playback position retention when app/service is closed or backgrounded.
- Added more robust last-track restore when document URIs change.
- Added user-visible resume failure message when remote playback restore cannot open a track.

## Sideload APK

- `releases/AudioBookPlayer-v1.0.2-debug-sideload.apk`
